                        ...
                        child: ClipOval(
                          child: () {
                            if (state is ShopLoaded &&
                                state.shop.logoUrl != null &&
                                state.shop.logoUrl!.isNotEmpty) {
                              final logoStr = state.shop.logoUrl!;
                              bool isBase64 = false;
                              Uint8List? bytes;
                              if (!logoStr.startsWith('http') && logoStr.length > 200) {
                                try {
                                  bytes = base64Decode(logoStr);
                                  isBase64 = true;
                                } catch (_) {}
                              }
            ...
            _buildListGroup(
              children: [
                ...
                _buildListItem(
                  ...
                  subtitle: 'View past sales records',
